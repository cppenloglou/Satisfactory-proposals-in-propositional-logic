...
current_directory = os.getcwd() + "\\..\\M200-1200_N10_K6_26_TEST5"
...
csv_file_path = os.path.join(current_directory, "hillTime.csv")
...
with open(csv_file_path, mode='w', newline='') as csvfile:
    ...
    for test_num in range(1, num_tests + 1):
        ...
        for iteration_num in range(1, test_iterations + 1):
            ...
            filename = f"solution_hill_test{test_num}_M{m_value}_N10_K6_{iteration_num}.txt"
